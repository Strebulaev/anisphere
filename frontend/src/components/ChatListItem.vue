    ...
    <div class="flex items-center p-3 hover:bg-gray-50 cursor-pointer">
      ...
      <div class="relative mr-3">
        ...
        <div
          ...
          class="absolute -bottom-0.5 -right-0.5 bg-green-500 text-white text-xs rounded-full px-1 min-w-[18px] h-4 flex items-center justify-center border border-white"
        >
          {{ chat.onlineCount }}
        </div>
      </div>
...
.chat-list-item.active .text-gray-900 {
  @apply text-blue-700;
}
