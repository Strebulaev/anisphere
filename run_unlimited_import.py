...
# -*- coding: utf-8 -*-
"""
Полный импорт аниме без ограничений
"""
import os
import sys
import django
...
def main():
    """Главная функция"""
    print("\n" + "="*80)
    print("UNLIMITED ANIME IMPORT WITH IMAGES")
    print("="*80)
    ...
    print("\nThis will import ALL anime from:")
    print("  Phase 1: All trending, popular, top-scored, favourites anime")
    print("  Phase 2: All anime from last 10 years (sorted by score)")
    print("  Phase 3: All TV, Movie, OVA, ONA anime (sorted by score)")
    ...
    if total > 0:
        ...
        print(f"  With studios: {with_studios:,} ({with_studios/total*100:.1f}%)")
    ...
    for i, anime in enumerate(examples, 1):
        ...
        print(f"      Status: {anime.status}, Type: {anime.kind}")
        print()
