...
# Р’СЃРµ СЂР°Р·СЂРµС€С‘РЅРЅС‹Рµ origins (env РїРµСЂРµРјРµРЅРЅР°СЏ РїРµСЂРµРєСЂС‹РІР°РµС‚ РґРµС„РѕР»С‚)
# ── CORS ─────────────────────────────────────────────────────────
# Nginx НЕ добавляет CORS-заголовки — только Django.
# CORS_ALLOWED_ORIGINS из .env переопределяет дефолт.
...
# В prod — только список выше; в dev — всё
