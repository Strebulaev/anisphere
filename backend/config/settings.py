...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=30),  # РЈРјРµРЅСЊС€РёС‚Рµ РґР»СЏ Р±РµР·РѕРїР°СЃРЅРѕСЃС‚Рё
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DB_HOST', 'localhost'),  # РРјСЏ СЃРµСЂРІРёСЃР° РІ docker-compose
...
if not DEBUG:
    ...
    CSRF_TRUSTED_ORIGINS = [
        'https://anisphere.ru', 'https://www.anisphere.ru',
